...
function impResultParts(item) {
  ...
  // fetch_fail/card_failed; VPS повторяет ежедневно по слотам
  // 12:00–20:00, новые задания проверяет круглосуточно каждые 5 минут). Прежнее
  ...
  // Ручной запасной выход оставлен: сервер или сайт суда могут быть
